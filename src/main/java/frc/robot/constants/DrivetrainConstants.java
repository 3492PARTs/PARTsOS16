...
public class DrivetrainConstants {
  ...
  // vision).
  public static final edu.wpi.first.math.Vector<N3> STABLE_STDEVS =
      VecBuilder.fill(kFlatXStdDevMeters, kFlatYStdDevMeters, kFlatThetaStdDevRad);
  ...
  public static final edu.wpi.first.math.Vector<N3> AIRBORNE_STDEVS =
      VecBuilder.fill(kHumpXStdDevMeters, kHumpYStdDevMeters, kHumpThetaStdDevRad);
}
