...
public interface CameraConstants {
  ...
  public Camera[] LimelightCameras =
      new Camera[] {
        new Camera(
            CameraName.LEFT_FRONT_CAMERA.getCameraName(),
            new Pose3d(
                PARTsUnit.InchesToMeters.apply(13.5),
                PARTsUnit.InchesToMeters.apply(9.75),
                PARTsUnit.InchesToMeters.apply(13.0),
                new Rotation3d(0, 0, 0)),
            true),
        new Camera(
            CameraName.LEFT_SIDE_CAMERA.getCameraName(),
            new Pose3d(
                PARTsUnit.InchesToMeters.apply(9.75),
                PARTsUnit.InchesToMeters.apply(12.25),
                PARTsUnit.InchesToMeters.apply(13.0),
                new Rotation3d(0, 0, Units.degreesToRadians(90))),
            true),
        new Camera(
            CameraName.RIGHT_FRONT_CAMERA.getCameraName(),
            new Pose3d(
                PARTsUnit.InchesToMeters.apply(13.5),
                -PARTsUnit.InchesToMeters.apply(9.75),
                PARTsUnit.InchesToMeters.apply(13.0),
            ...
            true),
        new Camera(
            CameraName.RIGHT_SIDE_CAMERA.getCameraName(),
            new Pose3d(
                PARTsUnit.InchesToMeters.apply(9.0),
                -PARTsUnit.InchesToMeters.apply(11.75),
                PARTsUnit.InchesToMeters.apply(13.0),
                new Rotation3d(0, 0, Units.degreesToRadians(-90))),
            true)
      };
