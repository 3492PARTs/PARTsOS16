...
public class RobotConstants {
  ...
  public static final PARTsUnit ROBOT_VISION_OFFSET =
      new PARTsUnit(HALF_ROBOT_WIDTH.getValue() + BUMPER_WIDTH.getValue(), PARTsUnitType.Inch);
  public static final PARTsUnit ROBOT_VISION_L4_OFFSET =
      new PARTsUnit(ROBOT_VISION_OFFSET.getValue() + 4, PARTsUnitType.Inch);
