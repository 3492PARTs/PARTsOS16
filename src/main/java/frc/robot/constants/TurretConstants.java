...
public class TurretConstants {
   ...
   *
   * <p>TODO: Get proper DIO port.
   */
  public static final int TURRET_ENCODER_PORT = 0;

  /**
   * Even knowing that the {@link frc.robot.util.PARTsThroughBoreEncoder PARTsThroughBoreEncoder}
   * takes in the angle in degrees, it's still good practice to use units.
   */
