...
public class Superstructure extends PARTsSubsystem {
  ...
  public Command shoot(BooleanSupplier end, TurretState turretState) {
    ...
    Command c =
        Commands.sequence(
                    ...
                    Commands.repeatingSequence(
                            new ConditionalCommand(
                                hopper
                                    ...
                                    .onlyIf(
                                        () ->
                                            hopper.getState() != HopperState.REVERSE
                                                && hopper.getState() != HopperState.ROLLING),
                                hopper
                                    .idle()
                                    .onlyIf(
                                        () ->
                                            hopper.getState() != HopperState.IDLE
                                                && hopper.getState() != HopperState.REVERSE),
                                    ...
                                    .onlyIf(
                                        () -> {
                                          return kicker.getState() != KickerState.ROLLING
                                              && kicker.getState() != KickerState.REVERSE;
                                        }),
                                Commands.parallel(
                                        kicker.idle(),
            ...
            // a valid angle.
            Commands.waitUntil(() -> end.getAsBoolean())
                .andThen(
                    Commands.runOnce(
                        () -> {
                          reset();
    ...
    try {
      c =
          Commands.sequence(
              Commands.parallel(
                  AutoBuilder.followPath(
                      PathPlannerPath.fromPathFile(
                          left ? "LeftTrenchToCenter" : "RightTrenchToCenter")),
                  Commands.sequence(new WaitCommand(.3), intake.intake())),
              AutoBuilder.followPath(
                  PathPlannerPath.fromPathFile(
                      left ? "LeftCenterCollectBalls" : "RightCenterCollectBalls")),
              AutoBuilder.followPath(
                  PathPlannerPath.fromPathFile(
                      left ? "LeftCenterToTrench1" : "RightCenterToTrench1")),
              AutoBuilder.followPath(
                  PathPlannerPath.fromPathFile(
                      left ? "LeftCenterToTrench2" : "RightCenterToTrench2")),
              intake.idle(),
              Commands.deadline(
                  new WaitCommand(7),
              ...
              intake.intake(),
              AutoBuilder.followPath(
                  PathPlannerPath.fromPathFile(left ? "LeftToMiddle" : "RightToMiddle")));
      ...
      c =
          Commands.sequence(
              ...
              Commands.parallel(
                  shoot(() -> false, TurretState.TRACKING_HUB),
                  AutoBuilder.followPath(
                      PathPlannerPath.fromPathFile("RightTrenchForwardToOutpost")),
                  Commands.sequence(new WaitCommand(7), intake.intakeShooting())));
    } catch (FileVersionException | IOException | ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
    ...
    try {
      c =
          Commands.sequence(
              ...
              AutoBuilder.followPath(PathPlannerPath.fromPathFile("OutpostToRightRamp")));
    } catch (FileVersionException | IOException | ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
  ...
  public Command rampDepotAuto() {
    ...
    try {
      c =
          Commands.sequence(
              Commands.parallel(
                  AutoBuilder.followPath(PathPlannerPath.fromPathFile("LeftRampToDepot")),
                  intake.intake()),
              AutoBuilder.followPath(PathPlannerPath.fromPathFile("DepotCenter2")),
              new WaitCommand(2),
              Commands.parallel(
                  shoot(() -> false, TurretState.TRACKING_HUB),
                  Commands.sequence(new WaitCommand(3), intake.intakeShooting())));
      ...
      c =
          Commands.sequence(
              ...
              Commands.parallel(
                  ...
                  AutoBuilder.followPath(
                      PathPlannerPath.fromPathFile("RightTrenchForwardToOutpost")),
                  Commands.sequence(new WaitCommand(9), intake.intakeShooting())));
    } catch (FileVersionException | IOException | ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
    }
  ...
  public Command rightMiddleDelayAuto() {
    ...
    try {
      c =
          Commands.sequence(
              Commands.deadline(new WaitCommand(15), shoot(() -> false, TurretState.TRACKING_HUB)),
              AutoBuilder.followPath(PathPlannerPath.fromPathFile("RightMiddleDelay")),
              intake.intake());
    } catch (FileVersionException | IOException | ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
  ...
  public Command leftMiddleDelayAuto() {
    ...
    try {
      c =
          Commands.sequence(
              Commands.deadline(new WaitCommand(15), shoot(() -> false, TurretState.TRACKING_HUB)),
              AutoBuilder.followPath(PathPlannerPath.fromPathFile("LeftMiddleDelay")),
              intake.intake());
    } catch (FileVersionException | IOException | ParseException e) {
      // TODO Auto-generated catch block
      e.printStackTrace();
