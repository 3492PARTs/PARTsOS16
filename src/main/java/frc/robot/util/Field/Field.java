...
public interface Field {
        ...
        AprilTag APRILTAGS[] = {
                        ...
                        new AprilTag(4, new Pose3d(
                                        ...
                                        new Rotation3d(Units.degreesToRadians(30), Units.degreesToRadians(0),
                        ...
                        new AprilTag(14,
                                        new Pose3d(
                                                        new Translation3d(Units.inchesToMeters(325.68),
                                                                        Units.inchesToMeters(241.64),
                                                                        Units.inchesToMeters(73.54)),
                                                        new Rotation3d(Units.degreesToRadians(30),
                                                                        Units.degreesToRadians(0),
                                                                        Units.degreesToRadians(180)))),
                        new AprilTag(15,
                                        new Pose3d(
                        ...
                        new AprilTag(18,
                                        new Pose3d(
                                                        new Translation3d(Units.inchesToMeters(144.0 /*-/13.5*/),
        ...
        /*** REEF ***/
        Translation2d ALLIANCE_REEF_CENTER = new Translation2d(Units.inchesToMeters(144.0 + (93.5 - 14.0 * 2) / 2),
                        Field.WIDTH / 2);
        ...
        public enum CoralStation {
                ...
                RED_KL_CORAL_STATION(NamedTags.RED_KL_CORAL_STATION,
                                new Translation2d(Field.LENGTH, Field.WIDTH / 2 - Units.inchesToMeters(109.13)),
                ...
                private CoralStation(NamedTags correspondingAprilTag, Translation2d blueOriginLineStart,
