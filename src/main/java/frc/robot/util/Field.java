...
public interface Field {
    ...
    public final Pose2d blueHubCenter = new Pose2d(LENGTH / 2.0 - Units.inchesToMeters(143.5), WIDTH / 2.0,
    ...
    public static boolean isInAllianceZone(Pose2d pose) {
        return RobotContainer.isBlue() ? pose.getX() < getTag(22).getLocation().getX()
