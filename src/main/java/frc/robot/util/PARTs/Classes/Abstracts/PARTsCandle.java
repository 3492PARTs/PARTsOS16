...
public abstract class PARTsCandle extends PARTsSubsystem {
  ...
  protected void runLarsonAnimation(
      Color color, double speed, LarsonAnimation.BounceMode bounceMode, int size) {
  ...
  protected void runTwinkleAnimation(
      Color color, double speed, TwinklePercent twinklePercent, int offset) {
  ...
  private LarsonAnimation getLarsonAnimation(
      Color color, double speed, LarsonAnimation.BounceMode bounceMode, int size) {
    // Size max is 7
  ...
  private TwinkleAnimation getTwinkleAnimation(
      Color color, double speed, TwinklePercent twinklePercent, int offset) {
    return new TwinkleAnimation(
        color.r, color.g, color.b, 0, speed, LED_LENGTH, twinklePercent, offset);
  }
  ...
  private ColorFlowAnimation getColorFlowAnimation(
      Color color, double speed, Direction direction, int offset) {
    return new ColorFlowAnimation(
        color.r, color.g, color.b, 0, speed, LED_LENGTH, direction, offset);
  }
