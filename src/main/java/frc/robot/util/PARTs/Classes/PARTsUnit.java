...
public class PARTsUnit {
  ...
  /**
   * Get the current unit type for an instance of {@link frc.robot.util.PARTs.Classes.PARTsUnit
   * PARTsUnit}.
   *
   * @return The unit type as a {@link frc.robot.util.PARTs.Classes.PARTsUnit.PARTsUnitType
   *     PARTsUnitType}.
   */
   ...
   * Converts current unit into the requested unit.
   *
   * @param unitType The target {@link frc.robot.util.PARTs.Classes.PARTsUnit.PARTsUnitType
   *     PARTsUnitType}.
